            ...
            <div className="flex flex-1 flex-col items-start gap-8">
                ...
                <div className="flex flex-col items-start gap-4 self-stretch">
                  ...
                  <div className="flex flex-col items-start gap-6 self-stretch">
                    ...
                    <p className="self-stretch text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                      At TecNext, we believe that every customer is unique. Our
                      approach focuses on creating tailored journeys that
                      resonate with individual needs and preferences.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col items-start gap-4 self-stretch">
                  <div className="flex flex-col gap-6 py-2 self-stretch md:flex-row md:items-start">
                    <div className="flex flex-col items-start gap-4 flex-1">
                      ...
                      <p className="self-stretch text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                        We analyze customer data to design experiences that
                    ...
                    <div className="flex flex-col items-start gap-4 flex-1">
                      ...
                      <p className="self-stretch text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                        Our strategies enhance interaction, ensuring customers
                        feel valued and understood throughout their journey.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Button variant="link" size="default" className="gap-2">
                  ...
                  >
                    <path
                      d="M9.3877 6.67285C9.48852 6.67285 9.56549 6.70326 9.64355 6.78125L14.5879 11.7256C14.6418 11.7795 14.667 11.8215 14.6787 11.8496V11.8506C14.6935 11.8861 14.7021 11.9259 14.7021 11.9746C14.7021 12.0233 14.6935 12.0631 14.6787 12.0986V12.0996C14.667 12.1277 14.6418 12.1697 14.5879 12.2236L9.61914 17.1924C9.54137 17.2702 9.47423 17.292 9.39355 17.2891C9.29953 17.2856 9.21866 17.2537 9.13281 17.168C9.05469 17.0898 9.02344 17.013 9.02344 16.9121C9.02344 16.8112 9.05469 16.7344 9.13281 16.6562L13.8145 11.9746L9.10742 7.26758C9.02976 7.18988 9.00781 7.12357 9.01074 7.04297C9.01419 6.9487 9.04676 6.86731 9.13281 6.78125C9.21074 6.70344 9.28711 6.67293 9.3877 6.67285Z"
                      fill="#0C0801"
                      stroke="#0C0801"
                    />
                  </svg>
        ...
        <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-12 lg:flex-row lg:items-start lg:gap-16">
          <div className="flex flex-1 flex-col items-start gap-6">
            ...
            <div className="flex flex-col items-start gap-8 flex-1">
              <div className="flex flex-col items-start gap-8 self-stretch">
                <p className="self-stretch text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                  Our omnichannel customer support ensures seamless interactions
                  across all platforms. We prioritize customer satisfaction by
                ...
                <div className="flex flex-col items-start gap-4 self-stretch">
                  <div className="flex flex-col gap-6 py-2 self-stretch md:flex-row md:items-start">
                    ...
                    <div className="flex flex-col items-start gap-4 flex-1">
                      ...
                      <p className="self-stretch text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                        Tailored support that meets the unique needs of each
                        customer.
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex flex-col items-start gap-8 flex-1">
              <div className="flex flex-col items-start gap-4 self-stretch">
                ...
                <div className="flex flex-col items-start gap-6 self-stretch">
                  ...
                  <p className="self-stretch text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                    Customer feedback loops are essential for understanding
                    client needs and preferences. By leveraging analytics,
                    businesses can refine their strategies to enhance overall
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Button variant="link" size="default" className="gap-2">
                  ...
                  >
                    <path
                      d="M9.3877 7.17285C9.48852 7.17285 9.56549 7.20326 9.64355 7.28125L14.5879 12.2256C14.6418 12.2795 14.667 12.3215 14.6787 12.3496V12.3506C14.6935 12.3861 14.7021 12.4259 14.7021 12.4746C14.7021 12.5233 14.6935 12.5631 14.6787 12.5986V12.5996C14.667 12.6277 14.6418 12.6697 14.5879 12.7236L9.61914 17.6924C9.54137 17.7702 9.47423 17.792 9.39355 17.7891C9.29953 17.7856 9.21866 17.7537 9.13281 17.668C9.05469 17.5898 9.02344 17.513 9.02344 17.4121C9.02344 17.3112 9.05469 17.2344 9.13281 17.1562L13.8145 12.4746L9.10742 7.76758C9.02976 7.68988 9.00781 7.62357 9.01074 7.54297C9.01419 7.4487 9.04676 7.36731 9.13281 7.28125C9.21074 7.20344 9.28711 7.17293 9.3877 7.17285Z"
                      fill="#0C0801"
                      stroke="#0C0801"
                    />
                  </svg>
              ...
              <div className="flex flex-col items-start gap-8 flex-1">
                <div className="flex items-start gap-1">
                  {[...Array(5)].map((_, i) => (
                    ...
                    >
                      <path
                        d="M9.07185 0.612343C9.4156 -0.204115 10.5864 -0.204114 10.9301 0.612346L12.9589 5.43123C13.1039 5.77543 13.4315 6.01061 13.8076 6.0404L19.0736 6.45748C19.9659 6.52814 20.3276 7.62813 19.6479 8.2034L15.6358 11.5987C15.3492 11.8412 15.224 12.2218 15.3115 12.5843L16.5373 17.661C16.745 18.5211 15.7979 19.201 15.034 18.7401L10.5255 16.0196C10.2035 15.8252 9.79848 15.8252 9.47645 16.0196L4.96797 18.7401C4.20409 19.201 3.25693 18.5211 3.46461 17.661L4.6904 12.5843C4.77795 12.2218 4.6528 11.8412 4.36623 11.5987L0.354039 8.2034C-0.325741 7.62813 0.0360444 6.52814 0.928268 6.45748L6.19433 6.0404C6.57048 6.01061 6.89813 5.77543 7.04304 5.43123L9.07185 0.612343Z"
                        fill="white"
                      />
                    </svg>
                  ))}
                ...
                <blockquote className="self-stretch text-white font-alata text-[22px] font-normal leading-[140%] tracking-[-0.22px]">
                  "TecNext transformed our customer engagement strategy, leading
      ...
      <section className="flex flex-col items-center gap-16 self-stretch bg-white px-4 sm:px-8 lg:px-16 py-16 sm:py-24 lg:py-28">
        <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-12">
          <div className="flex flex-col gap-12 lg:flex-row lg:items-start lg:justify-between">
            <div className="flex max-w-[768px] flex-col items-start flex-1 gap-4">
        ...
        <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-12">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:gap-8">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Button
                size="default"
                className="border-[#3B82F6] bg-[#3B82F6] text-white"
              >
                Contact
              </Button>
              <Button variant="outline" size="default">
