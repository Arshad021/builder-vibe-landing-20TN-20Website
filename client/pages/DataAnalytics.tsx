  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(0deg, rgba(0, 0, 0, 0.50) 0%, rgba(0, 0, 0, 0.50) 100%), url('https://images.pexels.com/photos/577195/pexels-photo-577195.jpeg')",
        }}
      >
        <div className="flex max-w-[1280px] flex-col items-center lg:items-start gap-8 sm:gap-10 lg:gap-16 flex-1 self-stretch">
          <div className="flex max-w-[768px] flex-col items-center lg:items-start gap-4 sm:gap-6 flex-1 self-stretch text-center lg:text-left">
            ...
            <p className="self-stretch text-white font-montserrat text-base sm:text-lg font-normal leading-[150%]">
              Empower your business with data-driven insights for smarter
            ...
            <div className="flex flex-col items-center lg:items-start gap-8 flex-1 text-center lg:text-left">
              <div className="flex flex-col items-center lg:items-start gap-6 self-stretch text-center lg:text-left">
                ...
                <p className="self-stretch text-[#0C0801] font-montserrat text-base sm:text-lg font-normal leading-[150%]">
                  Advanced data analytics transforms raw data into strategic
                  insights. Leverage these insights to drive informed
                ...
                <div className="flex flex-col md:flex-row py-2 items-center md:items-start gap-4 md:gap-6 self-stretch">
                  <div className="flex flex-col items-center lg:items-start gap-4 flex-1">
                    ...
                    <p className="self-stretch text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                      Discover trends and patterns that empower your
                      organization to thrive in a competitive landscape.
                    </p>
                  </div>
                  <div className="flex flex-col items-center lg:items-start gap-4 flex-1">
                    <h3 className="self-stretch text-[#0C0801] font-alata text-[22px] font-normal leading-[140%] tracking-[-0.22px]">
                    ...
                    <p className="self-stretch text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                      Transform insights into strategies that drive growth and
              ...
              <div className="flex flex-col items-center lg:items-start gap-8 self-stretch">
                <div className="flex flex-col items-center lg:items-start gap-4 self-stretch text-center lg:text-left">
                  ...
                  <div className="flex flex-col items-center lg:items-start gap-6 self-stretch text-center lg:text-left">
                    ...
                    <p className="self-stretch text-white font-montserrat text-base sm:text-lg font-normal leading-[150%]">
                      Our Business Intelligence solutions provide powerful tools
                      and dashboards that enable decision-makers to access
                      real-time data. Transform your insights into actionable
                  ...
                  <div className="flex flex-col md:flex-row py-2 items-center md:items-start gap-4 md:gap-6 self-stretch">
                    <div className="flex flex-col items-center lg:items-start gap-4 flex-1">
                      ...
                      <p className="self-stretch text-white font-montserrat text-base font-normal leading-[150%]">
                        Visualize complex data to make informed decisions
                    ...
                    <div className="flex flex-col items-center lg:items-start gap-4 flex-1">
                      ...
                      <p className="self-stretch text-white font-montserrat text-base font-normal leading-[150%]">
                        Leverage analytics to drive business growth and enhance
        ...
        <div className="flex max-w-[1280px] flex-col items-center lg:items-start gap-8 lg:gap-16 self-stretch">
          <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10 lg:gap-20 self-stretch">
            <div className="flex flex-col items-center lg:items-start gap-8 flex-1 text-center lg:text-left">
              <div className="flex flex-col items-center lg:items-start gap-6 self-stretch text-center lg:text-left">
                <h2 className="self-stretch text-[#0C0801] font-alata text-3xl sm:text-4xl lg:text-5xl font-normal leading-[120%] tracking-[-0.44px]">
                  Unlock the Power of Data with Advanced Machine Learning and AI
                  Solutions
                </h2>
                <p className="self-stretch text-[#0C0801] font-montserrat text-base sm:text-lg font-normal leading-[150%]">
                  Harness the capabilities of machine learning and AI to drive
                  predictive analytics and streamline your processes. Our
                  tailored solutions empower businesses to make data-driven
              ...
              <div className="flex flex-col items-center lg:items-start gap-4 self-stretch text-center lg:text-left">
                <div className="flex flex-col md:flex-row py-2 items-center md:items-start gap-4 md:gap-6 self-stretch">
                  <div className="flex flex-col items-center lg:items-start gap-4 flex-1">
                    ...
                    <p className="self-stretch text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                      Transform data into actionable insights for smarter
                  ...
                  <div className="flex flex-col items-center lg:items-start gap-4 flex-1">
                    ...
                    <p className="self-stretch text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                      Automate routine tasks to enhance efficiency and focus on
        ...
        <div className="flex max-w-[1280px] flex-col items-center lg:items-start gap-8 lg:gap-16 self-stretch">
          <div className="flex max-w-[768px] flex-col items-center lg:items-start gap-4 self-stretch text-center lg:text-left">
            ...
            <div className="flex flex-col items-center lg:items-start gap-6 self-stretch text-center lg:text-left">
              ...
              <p className="self-stretch text-[#0C0801] font-montserrat text-base sm:text-lg font-normal leading-[150%]">
                At TecNext, we empower organizations to harness the power of
                data analytics. Our tailored solutions have enabled clients to
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-12 self-stretch">
              ...
              <div className="flex flex-col items-center lg:items-start gap-8 flex-1 text-center lg:text-left">
                ...
                <div className="flex flex-col items-center lg:items-start gap-6 self-stretch text-center lg:text-left">
                  ...
                  <p className="self-stretch text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                    We transformed a retail client's inventory management
              ...
              <div className="flex flex-col items-center lg:items-start gap-8 flex-1 text-center lg:text-left">
                ...
                <div className="flex flex-col items-center lg:items-start gap-6 self-stretch text-center lg:text-left">
                  ...
                  <p className="self-stretch text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                    Our analytics solutions enabled a financial firm to optimize
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8 lg:gap-10 lg:gap-16 self-stretch">
              <div className="flex flex-col items-center lg:items-start gap-8 flex-1 text-center lg:text-left">
                ...
                <blockquote className="self-stretch text-[#0C0801] font-alata text-[22px] font-normal leading-[140%] tracking-[-0.22px]">
                  "The data solutions provided by TecNext have revolutionized
              ...
              <div className="flex flex-col items-center lg:items-start gap-8 flex-1 text-center lg:text-left">
                ...
                <blockquote className="self-stretch text-[#0C0801] font-alata text-[22px] font-normal leading-[140%] tracking-[-0.22px]">
                  "Thanks to TecNext, we have harnessed our data effectively,
                ...
                <div className="flex flex-col items-center lg:items-start gap-6 sm:gap-8 self-stretch text-center lg:text-left">
                  <div className="flex flex-col items-center lg:items-start gap-4 self-stretch text-center lg:text-left">
                    <h3 className="self-stretch text-white text-center font-alata text-2xl sm:text-3xl font-normal leading-[140%] tracking-[-0.28px]">
                      Transforming Insights into Actionable Strategies for Your
                      Business
                    </h3>
                    <p className="self-stretch text-white text-center font-montserrat text-base font-normal leading-[150%]">
                      Our step-by-step approach ensures seamless integration of
                      data analytics into your operations.
                    </p>
                  </div>
              ...
              <div className="flex flex-col items-center lg:items-start gap-8 flex-1 text-center lg:text-left">
                ...
                <div className="flex flex-col items-center lg:items-start gap-6 sm:gap-8 self-stretch text-center lg:text-left">
                  <div className="flex flex-col items-center lg:items-start gap-4 self-stretch text-center lg:text-left">
                    ...
                    <p className="self-stretch text-white text-center font-montserrat text-base font-normal leading-[150%]">
                      We customize our analytics solutions to meet your specific
                      business needs.
                    </p>
                  </div>
                  <div className="flex flex-col items-center gap-2 self-stretch">
              ...
              <div className="flex flex-col items-center lg:items-start gap-8 flex-1 text-center lg:text-left">
                ...
                <div className="flex flex-col items-center lg:items-start gap-6 sm:gap-8 self-stretch text-center lg:text-left">
                  <div className="flex flex-col items-center lg:items-start gap-4 self-stretch text-center lg:text-left">
                    ...
                    <p className="self-stretch text-white text-center font-montserrat text-base font-normal leading-[150%]">
                      Our team provides ongoing support to ensure your analytics
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(0deg, rgba(0, 0, 0, 0.50) 0%, rgba(0, 0, 0, 0.50) 100%), url('https://images.pexels.com/photos/34070725/pexels-photo-34070725.jpeg')",
        }}
      >
        <div className="flex max-w-[1280px] flex-col items-center lg:items-start gap-8 lg:gap-16 self-stretch">
          <div className="flex max-w-[768px] flex-col items-center lg:items-start gap-6 sm:gap-8 self-stretch text-center lg:text-left">
            <div className="flex flex-col items-center lg:items-start gap-6 self-stretch text-center lg:text-left">
              ...
              <p className="self-stretch text-white font-montserrat text-base sm:text-lg font-normal leading-[150%]">
                Transform your business decisions with our expert data and
                analytics consultation services today.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4">
              <Button className="rounded-full border border-white bg-white text-[#0C0801] hover:bg-gray-100">
                Request
              </Button>
              <Button
                variant="secondary"
