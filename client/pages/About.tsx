...
const teamMembers = [
  {
    ...
    avatar:
      "https://api.builder.io/api/v1/image/assets/TEMP/placeholder-avatar.jpg?width=80&height=80",
    social: {
      linkedin: "#",
      twitter: "#",
      dribbble: "#",
            ...
            <div className="flex flex-col items-start gap-4 w-full">
              ...
              <div className="flex flex-col items-start gap-6 w-full">
                ...
                <p className="w-full text-[#0C0801] font-montserrat text-base md:text-lg font-normal leading-[150%]">
                  At TecNext, we harness technology to drive transformation and
                  create lasting business value for our clients.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col items-start gap-8 flex-1">
            <div className="flex flex-col items-start gap-4 w-full">
              ...
              <div className="flex flex-col items-start gap-6 w-full">
                ...
                <p className="w-full text-[#0C0801] font-montserrat text-base md:text-lg font-normal leading-[150%]">
                  At TecNext, we envision a future where digital transformation
                  drives sustainable growth and innovation. Our commitment to
                  excellence empowers businesses to navigate the complexities of
          ...
          <div className="flex flex-col items-start gap-8 flex-1">
            <div className="flex flex-col items-start gap-6 w-full">
              ...
              <p className="w-full text-white font-montserrat text-base md:text-lg font-normal leading-[150%]">
                At TecNext, we believe that collaboration is the cornerstone of
                success. By working closely with our clients, we tailor
              ...
              <div className="flex py-2 items-start gap-6 w-full">
                <div className="flex flex-col items-start gap-4 flex-1">
                  ...
                  <p className="w-full text-white font-montserrat text-sm md:text-base font-normal leading-[150%]">
                    Your objectives guide our strategies, ensuring alignment and
                    shared success throughout our partnership.
                  </p>
                </div>
                <div className="flex flex-col items-start gap-4 flex-1">
                  <h3 className="w-full text-white font-alata text-[18px] md:text-[22px] font-normal leading-[140%] tracking-[-0.18px] md:tracking-[-0.22px]">
                  ...
                  <p className="w-full text-white font-montserrat text-sm md:text-base font-normal leading-[150%]">
                    Together, we innovate and adapt, fostering a culture of
          ...
          <div className="flex flex-col items-start gap-8 flex-1">
            <div className="flex flex-col items-start gap-6 w-full">
              ...
              <div className="flex flex-col items-start gap-6 w-full">
                ...
                <p className="w-full text-[#0C0801] font-montserrat text-base md:text-lg font-normal leading-[150%]">
                  At TecNext, our team excels in guiding enterprise clients
                  through their digital transformation journeys. We leverage our
                  expertise in strategic transformation, project assurance,
                  eCommerce excellence, data analytics, customer experience, and
                  information risk management to drive impactful results.
                </p>
              </div>
            </div>
            <div className="flex items-center gap-6">
