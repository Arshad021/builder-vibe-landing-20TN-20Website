    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative">
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(0deg, rgba(0, 0, 0, 0.50) 0%, rgba(0, 0, 0, 0.50) 100%), url('https://images.pexels.com/photos/225769/pexels-photo-225769.jpeg')",
          }}
        >
          <div className="max-w-[1280px] w-full flex flex-col gap-20">
            <div className="max-w-[768px] flex flex-col gap-6">
              ...
              <p className="text-white font-montserrat text-lg font-normal leading-[150%]">
                Safeguard your enterprise with our comprehensive Technology Risk
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <p className="text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                      Our Risk Assessment services identify potential
                      vulnerabilities and threats to your organization. We
                      provide actionable insights to enhance your cybersecurity
                      posture.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex py-2 items-start gap-6">
                    <div className="flex flex-col gap-4 flex-1">
                      ...
                      <p className="text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                        Pinpoint vulnerabilities that could jeopardize your
                    ...
                    <div className="flex flex-col gap-4 flex-1">
                      ...
                      <p className="text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                        Develop strategies to reduce risks and protect your
                        assets effectively.
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex flex-col gap-8 flex-1">
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                    Developing a comprehensive cybersecurity strategy is
                    essential for protecting your organization from evolving
                    threats. Our approach includes meticulous policy creation
                    and effective implementation to ensure your security
                    measures are both proactive and responsive.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-20">
            <div className="flex flex-col gap-6 flex-1">
              <h2 className="text-white font-alata text-[44px] font-normal leading-[120%] tracking-[-0.44px]">
                Swift Incident Response and Management for Unmatched
                Cybersecurity Resilience
              </h2>
              <p className="text-white font-montserrat text-lg font-normal leading-[150%]">
                At TecNext, we provide comprehensive incident response and
                management services to help organizations swiftly address and
                recover from security breaches. Our expert team ensures that
                your business minimizes damage and restores operations
                efficiently, safeguarding your digital assets.
              </p>
            </div>
            <img
              className="h-[640px] flex-1 aspect-[15/16] rounded-2xl object-cover"
        ...
        <div className="max-w-[1280px] w-full flex flex-col gap-20">
          <div className="flex items-start gap-20">
            ...
            <div className="flex-1 text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
              In today's digital landscape, safeguarding your enterprise is
              paramount. Our Technology Risk Management & Cybersecurity services
              ensure your organization is protected against evolving threats. We
              offer tailored solutions that align with your business goals and
            ...
            <div className="flex items-start gap-12">
              <div className="flex flex-col gap-8 flex-1">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                    Stay ahead of regulatory requirements and industry
                    standards.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-[1280px] w-full flex flex-col items-center gap-20">
          <div className="max-w-[768px] flex flex-col items-center gap-8">
            ...
            <h3 className="text-[#0C0801] text-center font-alata text-[28px] font-normal leading-[140%] tracking-[-0.28px]">
              "TecNext's expertise in cybersecurity transformed our risk
              management approach, ensuring our data is secure and our
              operations are resilient."
            </h3>
            <div className="flex w-[300px] flex-col items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-gray-300 overflow-hidden">
                <img
                  src="https://images.pexels.com/photos/31422830/pexels-photo-31422830.png"
        ...
        <div className="max-w-[1280px] w-full flex flex-col gap-20">
          <div className="max-w-[768px] flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                At TecNext, we prioritize your security needs. Our comprehensive
                approach ensures that your organization is protected against
                evolving threats.
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-16">
            <div className="flex items-start gap-12">
              <div className="flex flex-col gap-6 flex-1">
                ...
                <p className="text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                  We begin by identifying vulnerabilities within your existing
                  systems.
                </p>
              </div>
              <div className="flex flex-col gap-6 flex-1">
      ...
      <div className="flex py-28 px-16 flex-col items-center gap-20 bg-white">
        <div className="max-w-[1280px] w-full flex flex-col gap-20">
          <div className="flex items-start gap-20">
            ...
            <div className="flex flex-col gap-8 flex-1">
              <p className="text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                Are you prepared to protect your business from evolving cyber
                threats? Schedule a consultation with our experts to explore
                tailored solutions in Technology Risk Management and
                Cybersecurity.
              </p>
