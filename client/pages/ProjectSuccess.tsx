...
export default function ProjectSuccess() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative flex items-center justify-center min-h-[369px] px-16 py-28 bg-gradient-to-b from-black/50 to-black/50" 
        style={{
          backgroundImage: "url('https://api.builder.io/api/v1/image/assets/TEMP/85b8e6c434e0507ae0f008fc8bddab4ec0777453?width=2880')",
        ...
        <div className="max-w-[1280px] w-full">
          <div className="max-w-[768px] space-y-6">
            ...
            <p className="text-white font-montserrat text-lg font-normal leading-[150%]">
              Unlock your potential with our tailored strategies for successful project execution and digital transformation.
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                      At TecNext, we believe that successful projects are built on a foundation of clear communication and strategic planning. Our tailored approach ensures that every project aligns with your business goals and delivers measurable results.
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-[1280px] mx-auto space-y-20">
          <div className="max-w-[768px] mx-auto text-center space-y-4">
            ...
            <div className="space-y-6">
              ...
              <p className="text-white font-montserrat text-lg font-normal leading-[150%]">
                Our Project Success Enablement service ensures your projects are strategically planned and executed with precision. We focus on measurable outcomes that drive your business forward.
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col items-center gap-6 text-center">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-white font-montserrat text-base font-normal leading-[150%]">
                    We develop tailored strategies that align with your business goals.
                  </p>
                </div>
              </div>
            ...
            <div className="flex-1 space-y-8">
              <div className="space-y-6">
                <h2 className="text-[#0C0801] font-alata text-4xl font-normal leading-[120%] tracking-[-0.44px]">
                  Strategic Planning: Defining Goals and Success Criteria for Project Success
                </h2>
                <p className="text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                  At TecNext, we specialize in strategic planning that aligns project goals with business objectives. Our approach ensures clarity in scope and measurable success criteria, setting the foundation for project excellence.
                </p>
              </div>
              <div className="space-y-4 py-2">
                <div className="flex items-center gap-4">
        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="flex items-center gap-20">
            ...
            <div className="flex-1 space-y-8">
              <div className="space-y-6">
                <h2 className="text-[#0C0801] font-alata text-4xl font-normal leading-[120%] tracking-[-0.44px]">
                  Achieving Project Success Through Proven Methodologies and Best Practices
                </h2>
                <p className="text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                  At TecNext, we prioritize execution excellence to deliver successful projects. Our methodologies ensure that every phase is meticulously planned and executed.
                </p>
              </div>
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-6 py-2">
                  <div className="space-y-4">
                    ...
                    <p className="text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                      We adapt quickly to changes, ensuring projects remain aligned with client goals.
                    </p>
                  </div>
                  <div className="space-y-4">
                    <h3 className="text-[#0C0801] font-alata text-xl font-normal leading-[140%] tracking-[-0.22px]">
                    ...
                    <p className="text-[#0C0801] font-montserrat text-base font-normal leading-[150%]">
                      Our rigorous testing processes guarantee that deliverables meet the highest standards.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-[#0C0801] font-montserrat text-lg font-normal leading-[150%]">
                      Utilize advanced tools and metrics to monitor project performance. Ensure every initiative aligns with your business objectives for maximum impact.
                    </p>
                  </div>
                </div>
                <div className="space-y-4">
      ...
      {/* CTA Section */}
      <section className="py-28 px-16 relative"
        style={{
          backgroundImage: "linear-gradient(0deg, rgba(0, 0, 0, 0.50) 0%, rgba(0, 0, 0, 0.50) 100%), url('https://api.builder.io/api/v1/image/assets/TEMP/2fcfd92e6f4c707b1a0e56bb612fb87c27a4aaeb?width=2880')",
          backgroundSize: 'cover',
          backgroundPosition: 'center',
        }}>
        <div className="max-w-[1280px] mx-auto">
          <div className="max-w-[768px] space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-white font-montserrat text-lg font-normal leading-[150%]">
                Schedule a consultation to explore how we can drive your project success together.
              </p>
            </div>
